...
public class GameMaster {
    ...
    public var opponentGamePainter : GamePainter;
    ...
    public function doGameMasterActions(frameNo : int) : void {
        if(frameNo % delay == 0){
            if(moveDownCollision()){
               ...
               //we add new block only when old one attaches
    ...
    //TODO change method to send update to server and get rows to add or remove
